...
// qmk compile -kb keebio/iris/rev4 -km cmseeling
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //----------+----------+----------+----------+----------+----------+----------+      ----------+----------+----------+----------+----------+----------+----------+
      KC_LGUI,    KC_Z,      KC_X,      KC_C,      KC_V,      KC_B,  TD(TD_ENC),       TD(TD_GRV),   KC_N,      KC_M,    KC_COMM,    KC_DOT,    KC_SLSH, TD(TD_LAYR),
  //----------+----------+----------+----------+----------+----------+----------+      ----------+----------+----------+----------+----------+----------+----------+
  ...
  //                                      \----------+----------+----------/                \----------+----------+----------/
   ...
   [_GAME] = LAYOUT(
  //----------+----------+----------+----------+----------+----------+                            ----------+----------+----------+----------+----------+----------+
     _______,   _______,   _______,   _______,   _______,   _______,                                 KC_F5,    KC_F6,    _______,   _______,   _______,   _______,
  //----------+----------+----------+----------+----------+----------+                            ----------+----------+----------+----------+----------+----------+
     _______,   _______,   _______,   _______,   _______,   _______,                               _______,   _______,   _______,   _______,   _______,   _______,
  //----------+----------+----------+----------+----------+----------+                            ----------+----------+----------+----------+----------+----------+
     _______,   _______,   _______,   _______,   _______,   _______,                               _______,   _______,   _______,   _______,   _______,   _______,
  //----------+----------+----------+----------+----------+----------+----------+      ----------+----------+----------+----------+----------+----------+----------+
     _______,   _______,   _______,   _______,   _______,   _______,   _______,         _______,   _______,   _______,   _______,   _______,   _______,  TG(_GAME),
  //----------+----------+----------+----------+----------+----------+----------+      ----------+----------+----------+----------+----------+----------+----------+
                                            KC_LCTRL,  _______,   KC_LALT,                    _______,   _______,   _______
  //                                      \----------+----------+----------/                \----------+----------+----------/
  ),
  ...
  //----------+----------+----------+----------+----------+----------+----------+      ----------+----------+----------+----------+----------+----------+----------+
     RGB_HUD,   RGB_SAD,   RGB_VAD,   _______,   _______,   _______,   _______,         _______,   KC_PLUS,   KC_MINS,   _______,   _______,   _______,  TD(TD_LAYR),
  //----------+----------+----------+----------+----------+----------+----------+      ----------+----------+----------+----------+----------+----------+----------+
...
uint32_t layer_state_set_user(uint32_t state) {
	switch (biton32(state)) {
		...
		case _SYMBOL: rgblight_sethsv_noeeprom(132, 255, 128); break;
    case _GAME: rgblight_sethsv_noeeprom(96, 255, 128); break;
...
void layer_dance_finish (qk_tap_dance_state_t *state, void *user_data) {
  ql_tap_state.state = cur_dance(state);
  switch (ql_tap_state.state) {
    case SINGLE_TAP:
...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_LAYR] = ACTION_TAP_DANCE_FN_ADVANCED(NULL, layer_dance_finish, layer_dance_reset)
};
